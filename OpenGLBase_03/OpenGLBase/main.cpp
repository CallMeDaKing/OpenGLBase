...
void RenderScene(void) {
    ...
    shaderManager.UseStockShader(GLT_SHADER_DEFAULT_LIGHT,transformPipline.GetModelViewMatrix(), transformPipline.GetProjectionMatrix(), vRed);
...
void setupRC() {
    ...
    objectFrame.MoveForward(10.0f);
    
    // 绘制甜甜圈
    gltMakeTorus(torusBatch, 1, 0.3, 56, 28);
...
int main(int argc,char *argv[])  {
    ...
    */
    ...
    // 右键按钮事件
    glutCreateMenu(RroccessMenue);
    glutAddMenuEntry("Toggke depth test1", 1);
